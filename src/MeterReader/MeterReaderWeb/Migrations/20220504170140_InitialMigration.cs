    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 5, 4, 19, 1, 40, 528, DateTimeKind.Local).AddTicks(401), 1458.9000000000001 },
                    { 2, 1, new DateTime(2022, 5, 4, 19, 1, 40, 530, DateTimeKind.Local).AddTicks(7553), 18403.5 },
                    { 3, 2, new DateTime(2022, 5, 4, 19, 1, 40, 530, DateTimeKind.Local).AddTicks(7896), 0.0 },
                    { 4, 2, new DateTime(2022, 5, 4, 19, 1, 40, 530, DateTimeKind.Local).AddTicks(7902), 304.75 }
                });
